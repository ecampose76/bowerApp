...
const DISHES = [
  ...
  { id: "d-branzino", price: 48, name: "Whole Roasted Branzino", section: "Entrées", description: "Fennel, Meyer lemon, castelvetrano olive, herb salsa verde", pairedWineIds: ["w6"], quizClue: "A whole Mediterranean sea bass roasted with fennel and Meyer lemon inside the cavity, finished with a bright herb salsa verde.", dropLine: "whole roasted branzino with herb salsa verde", ingredients: "Whole branzino, fennel, Meyer lemon, castelvetrano olives, parsley, capers, garlic, olive oil", chefPrep: "Branzino cleaned and stuffed with fennel fronds and lemon slices, roasted whole until the skin crisps, filleted tableside, finished with a caper-garlic salsa verde and castelvetrano olives.", allergensInRecipe: ["fish", "citrus", "garlic"], allergensRemovable: ["garlic"] },
  ...
  { id: "d-haricots-verts", price: 12, name: "Haricots Verts Amandine", section: "Accompaniments", description: "Brown butter, toasted almond, shallot", pairedWineIds: ["w9"], quizClue: "Thin French green beans blanched crisp-tender, tossed in brown butter with toasted almonds and shallot.", dropLine: "haricots verts amandine", ingredients: "Haricots verts, butter, sliced almonds, shallot, lemon", chefPrep: "Beans blanched in heavily salted water and shocked to preserve color, finished in a hot pan with brown butter, toasted almonds, and shallot just before service.", allergensInRecipe: ["dairy", "tree nuts", "onion"], allergensRemovable: ["onion"] },
  ...
  { id: "d-farro-salad-side", price: 13, name: "Herbed Farro & Root Vegetable", section: "Accompaniments", description: "Roasted root vegetables, preserved lemon, herb oil", pairedWineIds: [], quizClue: "Nutty farro tossed with roasted root vegetables, preserved lemon, and fresh herbs.", dropLine: "herbed farro with roasted root vegetable", ingredients: "Farro, root vegetables (carrot, parsnip, turnip), preserved lemon, parsley, mint, olive oil", chefPrep: "Farro cooked al dente in vegetable stock, tossed warm with roasted root vegetables, preserved lemon, and fresh herbs, finished with olive oil.", allergensInRecipe: ["gluten", "citrus"], allergensRemovable: [] },
